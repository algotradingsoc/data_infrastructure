...
def volume_ratio_calc(data_directory, tickers, features, start, end):
    ...
    for x in range(len(data_df)):
        ...
        for i in range(len(stock) - 24):
            ...
            av_past25 = np.average(V_past25)  # average of past 25 days' volumes
            volume_ratio.append(TV / av_past25)  # this will be cleared by the end of each external for loops
